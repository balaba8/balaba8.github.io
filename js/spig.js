...
jQuery(document).ready(function ($) {
    ...
    $(".tie-input-bar .input-box textarea").focus(function(){
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        /*msgs = ["播报明日天气<iframe name=\"xidie\" src=\"http://i.tianqi.com/index.php?c=code&id=8&num=3\"frameborder=\“0\” scrolling=\"no\" height=\"80px\"  width=\"225px\" allowtransparency=\"true\" ></iframe>", "陪我聊天吧！","快快订阅我的博客吧！<a href=\"http://xiaosun.top/feed.xml\" target=\"_blank\" rel=\"external\" tip=\"Feed\"><img border=\"0\" title=\"订阅乱了感觉\" alt=\"Feed\" src=\"/images/site.png\" width=\"80\" height=\"80\"></a>", "好无聊哦，你都不陪我玩！", "…@……!………", "^%#&*!@*(&#)(!)(", "我可爱吧！嘻嘻!~^_^!~~","谁淫荡呀?~谁淫荡?，你淫荡呀!~~你淫荡！~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];*/
        msgs = ["朋友为什么总是放在一块就咬分开一会就想？","走狗的路让猫们说去吧……","作为一条狗我是被抛到这个世界上来的。","爱情很短叹息很长。","只要我不醒来世界就不存在。","老天忘了给我翅膀于是我用幻想飞翔。","一条狗其实不孤单想一条狗才会孤单。","生活的一半是倒霉另一半是如何处理倒霉。","听人说四十而不“活”幸好一条狗不用那么久。","记得结婚前,我好像一只鸟。","光着身子说假话总是不自然的。","就让我在树上呆着吧，等秋天和落叶一起落下。"]
        var i = Math.floor(Math.random() * msgs.length);
        showMessage(msgs[i], 15000);
    }, 20000);
});
